...
sudo bash -c 'cat << EOF > /etc/systemd/system/image-compression-service.service
[Unit]
...
ExecStart=/usr/bin/python3 -u /home/ubuntu/MastersThesis/application/image-compression-service/main.py
WorkingDirectory=/home/ubuntu/MastersThesis/application/image-compression-service
Restart=always
StandardOutput=file:/var/log/image-compression-service.log
StandardError=file:/var/log/image-compression-service.log
        ...
        "logs": {
                "logs_collected": {
                        "files": {
                                "collect_list": [
                                        {
                                                "file_path": "/var/log/image-compression-service.log",
                                                "log_group_name": "/aws/ec2/masters-thesis/image-compression-service",
